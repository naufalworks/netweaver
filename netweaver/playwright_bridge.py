...
P2-004: Enables real-site orchestration without CloakBrowser.
"""
...
class PlaywrightBridge:
    ...
    def _close_browser(browser: Any) -> None:
        """Safely close a browser and its playwright instance."""
        if browser is None:
            return
        try:
            browser.close()
        ...
        try:
            ...
            if count == 0:
                return ActionabilityEvidence(
                    ...
                    selector=target_ref,
                    phase=Phase.PRE,
                    attached=False, visible=False, enabled=False,
    ...
    def _extract_element(
        ...
        try:
            ...
            return InteractiveElement(
                selector=selector, tag=tag, type=type_,
                text=text, aria_label=aria_label,
